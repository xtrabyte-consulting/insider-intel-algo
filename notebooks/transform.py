...
class NewAttributeCreator(BaseEstimator, TransformerMixin):
  ...
  def __init__(self, remove_zero_shares: bool = True, categorize_movement: bool = False, normalize_movemnt: bool = False, groupby: list = ['Ticker', 'Date', 'Name', 'TransactionCode', 'AcquiredDisposedCode']):
